...
physical_activity_level = st.sidebar.slider("Physical Activity" \
" Level (minutes/day)", min_value=30, max_value=90, value=60)
...
if st.sidebar.button("Predict"):
    ...
    try:
        ...
        # inverse transformation, here 0 means None, 1 means Insomania, so reverses the transfromation from 0 to None
